...
total_cd_votes = 7971  # total votes in the chosen cd
shd = "1"  # state house district
total_shd_votes = -1
ssd = 14  # state senate district
total_ssd_votes = -1
single_vote_type = "early-voting"  # pick any one from your file
con_votes_vote_type = -1
# pick any one from your file
single_county = "US-Virgin-Islands;St. Tomas / St. John"
con_votes_county = 7971  # total votes for pres of that county
